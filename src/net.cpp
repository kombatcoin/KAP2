...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "KappaCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"kappacoin.io", "dnsseed.kappacoin.io"},
    {"kappacoin.qa", "dnsseed.kappacoin.qa"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"kappacoin.io", "testnet-seed.kappacoin.io"},
    {"kappacoin.qa", "testnet-seed.kappacoin.qa"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. KappaCoin is probably already running."), addrBind.ToString().c_str());
        else
